...
"animationStart":STSType.ARRAY,"animationEnd":STSType.ARRAY,"animation":null,"othanimationStart":STSType.ARRAY,"othanimationEnd":STSType.ARRAY,"seaAniNumber":STSType.INT,"aniTimeBasic":null,"speedBasic":null,"ifOnlyAttBase":null,
...
"effValue":null,"effTime":STSType.ARRAY,"effTimes":STSType.INT,"attEffGoodOrBad":STSType.ARRAY,"attackEffect":null,"usuallyEffGoodOrBad":STSType.ARRAY,"usuallyEffect":null,"deathEffGoodOrBad":STSType.ARRAY,
...
var CardBuy
var Soldier = preload("res://sence/object.tscn")
...
func effect_calu(value,effValue,effectGoodOrBad,effectUncencal):
	#原始值+增值*是否处于该效果*好或坏*是否同时获得好坏值中和攻击效果恢复为原值
	if effectGoodOrBad == null: 
		return value*effValue
	else: 
		return value*effValue*effectGoodOrBad*effectUncencal
	pass

func TRvalue_caluORcreate(caluType,damager,target,projectile,proMode,proRange,aoeModel,aoeRange,aoeTime,aoeTimes,attackType,damage,damagerType,giveEffect,effValue,effTime,effTimes):
	...
	target.aoeTime = aoeTime
	target.aoeTimes = aoeTimes
