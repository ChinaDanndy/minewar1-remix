...
func _on_area_entered(area):
	...
	if ifAoeHold == false:
		...
		queue_free()
	else: Global.damage_Calu(area,Global.damCaluType.EFF,null,null,null,giveEffect,effValue,effTime,effTimes,Global.IfAoeType.IN)
	pass


func _on_area_exited(area):
	if ifAoeHold == true: Global.damage_Calu(area,Global.damCaluType.EFF,null,null,null,giveEffect,effValue,effTime,effTimes,Global.IfAoeType.OUT)
	pass
